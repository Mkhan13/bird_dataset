'''
Script to web scrape for images of starlings, grackles, blackbirds, and cowbirds from South Dakota
...
def download_bird_images(url):
    ...
    base_url = url.rsplit('/', 1)[0]  # Base URL for relative paths
    ...
    for img in img_tags:
        ...
        if img_url:
            img_url = get_full_img_url(img_url, base_url)
